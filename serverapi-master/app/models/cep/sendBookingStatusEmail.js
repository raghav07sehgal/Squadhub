...
var credentialConfig = require('../../utils/emailConfig.json');

//outlook configuration 
// var transporter = nodemailer.createTransport(credentialConfig.outlook);
//gmail configuration 
var transporter = nodemailer.createTransport(credentialConfig.gmail);
//mailOptions configuration 
var mailOptions = credentialConfig.mailOptions;
...
async function sendEmail() {
    ...
    for (let i = 0; i < emailData.length;) {
        ...
        if (totalHousr == 0) {
            var index = emailData.indexOf(emailData[i]);
